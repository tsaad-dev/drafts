...
The TE YANG module defined in this document has the common building blocks that are independent of
...
This model defines configuration, state, execution, and notifications data for
